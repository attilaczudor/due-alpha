...
export function Select<T0>(options:FSharpList_T<T0>, current:Var<T0>, toLabel:((a?:T0) => string), placeholder:string, accent:View_T<string>, accentHover:View_T<string>, isRightAligned:boolean):Doc
export function IconButton(icon:Doc, accentHover:View_T<string>, onClick:(() => void)):Doc
export function FullWidthButton(content:IEnumerable<Doc>, accent:View_T<string>, onClick:(() => void)):Doc
